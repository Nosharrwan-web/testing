...
class AppController extends Controller
{
    ...
    public function initialize()
    {
		...
		$this->Auth->allow(['index','display','view','edit','ab','frontfile','login','register'
		,'laptop','books','mobile','about_us','advertise','add','book_purchase','bought_products',
		'change_password','laptop_purchase','logout','message','sendm','mobile_purchase','purchase',
		'send_message','set_buyer','my_products',]);
